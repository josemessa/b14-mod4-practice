...
export function addToolbar() {
  ...
  elementContent.innerHTML = `<div class="container mt-4 mb-4 d-flex justify-content-between align-items-center">
    <div ><button class=" border border-secondary me-2 border-radius-1 border-2  " id="grid-display"><img src="grid-icon.svg" alt="">
    </button><button class=" border border-2 border-secondary " id="list-display"><img src="list-icon.svg" alt=""></button> </div>
  <div>
    <select
...
export function addBackToolbar() {
  ...
  <div class=""><button class=" border border-2 d-flex align-items-center p-1 border-secondary " id="back-button"><img src="back.svg" alt=""><h2 class="fs-5 ">  Volver atras</h2>
  </button></div>
